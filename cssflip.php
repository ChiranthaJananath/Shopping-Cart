    ...
    <body>		
		...
		<!--	<img class="pageBanner" src="themes/images/pageBanner.png" alt="New products" >-->
			...
			<section class="main-content">
                ...
                <?php  
                $query = "SELECT * FROM clothes WHERE type='kids' ORDER BY productCode ASC";  
                ...
                <div class="flipper"> 
                <div class="front">
                     <form method="post" action="kids.php?action=add&id=<?php echo $row["productCode"]; ?>">  <!-- there were id before now-->
...
?>                               <h4 class="text-info"><?php echo $row["brand"]; ?></h4>  
                     ...
                     <div class="back">
                        <p>Our productions </p>
                        <p>now you are going to watch them</p>
                     </div> 
                      </div>
  </div>
                </div>
