 ...
 {  
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="wedding.php"</script>';  
           }  
      }  
      else  
      {  
    ...
    <body>		
		...
		<!--	<img class="pageBanner" src="themes/images/pageBanner.png" alt="New products" >-->
			...
			<section class="main-content">
                ...
                <?php  
                $query = "SELECT * FROM clothes WHERE type='weddings' ORDER BY productCode ASC";  
                ...
                <div class="col-md-4">  
                     <form method="post" action="wedding.php?action=add&id=<?php echo $row["productCode"]; ?>">  <!-- there were id before now-->
                          <div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px;" align="center">  
                            <!--   <img src="<?php //echo $row["image"]; ?>" class="img-responsive" /><br />  -->
                        <!--    	<?php	//echo '<img src="data:image/jpg;base64,'.base64_encode( $row['image'] ).'"/>';?>    -->                           <h4 class="text-info"><?php echo $row["brand"]; ?></h4>  
						...
						<!--  table data getting-->
						 ...
						 <table class="table table-bordered">  
                          ...
                          <tr>  
                               ...
                               <td><a href="wedding.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>  
                          </tr>  
                          <?php  
