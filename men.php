    ...
    <body>		
		...
		<!--	<img class="pageBanner" src="themes/images/pageBanner.png" alt="New products" >-->
			...
			<section class="main-content">
                ...
                <?php  
                $query = "SELECT * FROM clothes WHERE type='men' ORDER BY productCode ASC";  
                ...
                <div class="col-md-4">  
                     <form method="post" action="men.php?action=add&id=<?php echo $row["productCode"]; ?>">  <!-- there were id before now-->
                          ...
                          <tr>  
                           ...
                           <tr>
                            ...
                            <tr>
                          		...
                          		<td align="right">$ <?php echo number_format($finalValue, 2); ?></td>
                          		<td></td>s
                          </tr>
                          <?php  
                          }  
