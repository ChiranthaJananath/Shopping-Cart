...
<html lang="en">
    ...
    <body>		
		...
		<!--	<img class="pageBanner" src="themes/images/pageBanner.png" alt="New products" >-->
				<h4><span>Women Products</span></h4>
			</section>
			<section class="main-content">
                ...
                <?php  
                $query = "SELECT * FROM clothes WHERE type='Women' ORDER BY productCode ASC";  
                ...
                ?>  
					...
					<form action="checkout.php" method="post">
						<input type="submit" name="chekoutBtn" style="margin-top:5px;" class="btn btn-success" value="Checkout" /> 
					</form>
					</div>
					<div class="span3 col">
						<div class="block">	
